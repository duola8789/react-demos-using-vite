...
(function() {
  ...
  var getPreviewAction = function(editor) {
      return editor.getParam('previewAction')
  }

  function registerCommand(editor) {
      editor.addCommand('previewAction', function() {
          var previewAction = getPreviewAction(editor);
          previewAction && previewAction(editor);
      })
  }
  ...
  function register(editor) {
      editor.ui.registry.addButton('preview', {
        ...
        tooltip: 'Preview',
        onAction: function () {
          return editor.execCommand('previewAction');
        }
      });
  }
