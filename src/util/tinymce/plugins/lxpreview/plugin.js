...
(function() {
    ...
    var open = function(editor, appendContent) {
        var content = getPreviewHtml(editor) + appendContent;
    ...
    var register = function(editor) {
        editor.addCommand('lxPreview', function(ui, val) {
            open(editor, val);
        });
        editor.__getPreviewHtml__ = getPreviewHtml;
    };
    ...
    //         tooltip: 'Preview',
    //         onAction: function() {
    //             return editor.execCommand('lxPreview');
    //         }
    //     });
    ...
    function Plugin() {
        global.add('lxpreview', function(editor) {
            register(editor);
            //register$1(editor);
        });
    }
