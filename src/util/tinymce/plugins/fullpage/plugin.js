...
(function() {
    ...
    var getBodyStyle = function(editor) {
        return editor.getParam('fullpage_body_style');
    };
    ...
    var getDefaultHeader = function(editor) {
        ...
        // if (value = getContentStyle(editor)) {
        //     header += '<style type="text/css" id="lxStyle">' + value + '</style>\n';
        // }
        ...
        var getFullpageBodyStyle = getBodyStyle(editor);
        if (getFullpageBodyStyle && typeof getFullpageBodyStyle === 'function') {
            styles += getFullpageBodyStyle();
        }
